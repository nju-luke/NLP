...
//        mean[0] = sumCenterLongitude / length ;
//        mean[1] = sumCenterLatitude / length ;
//        return mean;
//    }
//
...
//        double[][] coordinates = new double[2][coordinatesList.size()];
//        for (int i = 0; i < coordinatesList.size(); i++) {
//            coordinates[0][i] = coordinatesList.get(i)[0];
//            coordinates[1][i] = coordinatesList.get(i)[1];
//        }
//        return coordinates;
//    }
//
